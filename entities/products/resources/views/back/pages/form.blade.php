...
@section('content')
    ...
    <div class="row m-sm">
        <a class="btn btn-white" href="{{ route('back.products-finder.products.index') }}">
            ...
            <div class="col-md-6">
                <div class="product-image">
                    <a data-fancybox href="{{ url($item->getFirstMediaUrl('preview')) }}">
                        <img src="{{ url($item->getFirstMediaUrl('preview', 'preview_admin')) }}" class=" m-b-md img-responsive" alt="post_image">
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="wrapper wrapper-content">
        ...
        {!! Form::open(['url' => (! $item['id']) ? route('back.products-finder.products.store') : route('back.products-finder.products.update', [$item['id']]), 'id' => 'mainForm', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal']) !!}

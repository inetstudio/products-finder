...
class ProductsDataTableService extends DataTable implements ProductsDataTableServiceContract
{
    ...
    {
        $this->model = app()->make('InetStudio\ProductsFinder\Products\Contracts\Models\ProductModelContract');
    }
    ...
    {
        $transformer = app()->make('InetStudio\ProductsFinder\Products\Contracts\Transformers\Back\ProductTransformerContract');
